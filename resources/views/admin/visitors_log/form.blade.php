...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="x_content">
                        @if(isset($user_data))
                       {{Form::open(['url'=>route('visitorsLogUpdate',$user_data->id),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
                            @method('PUT')

                        @else
                        {{Form::open(['url'=>route('visitorsLogStore'),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
