...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="x_content">
                        @if(isset($user_data))
                       {{Form::open(['url'=>route('visitorsNotesUpdate',$user_data->id),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
                            @method('PUT')

                        @else
                        {{Form::open(['url'=>route('visitorsNotesStore'),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::text('notes', @$user_data->notes ,['class'=>'form-control','id'=>'notes']) }}
                                @if($errors->has('notes'))
