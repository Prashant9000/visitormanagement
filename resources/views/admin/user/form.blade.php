...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="x_content">
                        @if(isset($user_data))
                       {{Form::open(['url'=>route('user_update',$user_data->id),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
                            @method('PUT')

                        @else
                        {{Form::open(['url'=>route('user_store'),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
    ...
    <div class="col-sm-9">
        ...
        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                {{Form::select('role',['student'=>'Student','visitor'=>'Visitor'],@$user_data->role ,['class'=>'form-control','id'=>'role']) }}
                                @if($errors->has('role'))
