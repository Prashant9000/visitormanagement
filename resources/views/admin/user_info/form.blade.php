...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="x_content">
                        @if(isset($user_data))
                       {{Form::open(['url'=>route('usersInfoUpdate',$user_data->id),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
                            @method('PUT')

                        @else
                        {{Form::open(['url'=>route('usersInfoStore'),'class'=>'form', 'enctype'=>'multipart/form-data'])  }}
